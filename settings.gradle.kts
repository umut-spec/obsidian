...
if (!file(".git").exists()) {
    val errorText = """
        ...
        =====================[ ERROR ]=====================
         The Obsidian project directory is not a properly cloned Git repository.
         
         In order to build Obsidian from source you must clone
         the Obsidian repository using Git, not download a code
         zip from GitHub.
         
         See the README.md for further information on
         building and modifying Obsidian.
        ===================================================
    """.trimIndent()
    error(errorText)
}
...
// Obsidian modules
optionalInclude("obsidian-performance")
optionalInclude("obsidian-security")
